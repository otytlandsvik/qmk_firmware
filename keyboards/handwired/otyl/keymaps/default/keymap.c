...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [0] = LAYOUT(
        MO(3),   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                   KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS,
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                   KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        KC_TAB,  ALT_Z,   KC_X,    KC_C,    KC_V,    KC_B,                   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTL,
                          KC_LBRC, KC_RBRC,                                                    KC_PLUS, KC_EQL,
                                   MSPC,    GUI_ESC, MO(3),                  KC_LCTL, SFT_BSP, MENT
    ),

    [1] = LAYOUT(
        QK_BOOT, _______, KC_AMPR, KC_ASTR, _______, _______,                KC_AE,   KC_OE,   KC_AA,   KC_LPRN, KC_RPRN, _______,
